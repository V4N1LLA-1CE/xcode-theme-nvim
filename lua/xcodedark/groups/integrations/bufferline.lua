...
function M.setup(colors)
	local highlights = {
		...
		BufferLineBackground = { fg = colors.tab_inactive_fg, bg = colors.tab_inactive_bg },
		BufferLineFill = { bg = colors.tab_inactive_bg },

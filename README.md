...
NOTE: This theme works best in transparent mode as shown in the screenshots. In order to get the same autocomplete menu, check my `blink-completion.lua` in [nvim dotfiles](https://github.com/V4N1LLA-1CE/dotfiles/nvim)
